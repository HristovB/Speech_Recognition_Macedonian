# This file is taken from: https://github.com/baidu-research/ba-dls-deepspeech
...
from utilities import calc_feat_dim, spectrogram_from_file, text_to_int_sequence
from utilities import conv_output_length
...
class AudioGenerator():
    def __init__(self, step=10, window=20, max_freq=8000, mfcc_dim=13,
                 minibatch_size=20, desc_file=None, spectrogram=True, max_duration=20.0,
    ...
    def load_train_data(self, desc_file='F:\Speech_Recognition_Macedonian\Code\Code\src\\train_corpus_allSubjects.json'):
        self.load_metadata_from_desc_file(desc_file, 'train')
        self.fit_train()
        if self.sort_by_duration:
            self.sort_data_by_duration('train')

    def load_validation_data(self, desc_file='F:\Speech_Recognition_Macedonian\Code\Code\src\\valid_corpus.json'):
        self.load_metadata_from_desc_file(desc_file, 'validation')
        if self.sort_by_duration:
            self.sort_data_by_duration('valid')

    def load_test_data(self, desc_file='F:\Speech_Recognition_Macedonian\Code\Code\src\\test_corpus.json'):
