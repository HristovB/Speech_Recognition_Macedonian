...
"""
Script to create JSON line description files that can be used to
train deep speech models.

Works with data directories that are organized like LibriSpeech:
...
def main(data_directory, output_file):
    ...
    for group in os.listdir(data_directory):
        ...
        for speaker in os.listdir(speaker_path):
            ...
            for line in open(labels_file, encoding='utf8'):
